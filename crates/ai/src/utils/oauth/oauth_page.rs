...
fn render_page(options: RenderPageOptions<'_>) -> String {
...
mod tests {
    ...
    #[test]
    fn success_page_contains_escaped_message() {
        let html = oauth_success_html("<done>");
    ...
    fn error_page_escapes_details() {
        let html = oauth_error_html("Failed", Some("bad & \"quoted\""));
